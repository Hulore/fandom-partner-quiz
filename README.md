...
Фановый мультифандомный квиз: участник выбирает фандом, выбирает интерес `Парни / Девушки / Все`, отвечает на `10` случайных вопросов из банка `100`, получает романтический мэтч, а затем ИИ пишет короткую историю знакомства, отношений, совместной жизни и финала.
