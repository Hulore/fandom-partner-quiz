...
const FANDOMS = {
  ...
  jjk: fandom("jjk", "Магическая битва", "Проклятия, риск, юмор на грани и сильные характеры.", "Токио, школа магов, ночные миссии, проклятая энергия и разговоры после опасности", [
    ch("jjk_gojo", "Сатору Годжо", "GO", null, "Невозможный флирт, сила и хаос.", "Яркий, дерзкий, смешной, сильный и неожиданно внимательный.", ["харизма", "хаос", "флирт"], [-0.1,0.5,1,0.4,1,0.8,0.8,0.4,0.2,0.5]),
    ch("jjk_nanami", "Кэнто Нанами", "NA", null, "Стабильность, взрослость и любовь без цирка.", "Собранный, надёжный, усталый в лучшем смысле, уважает границы.", ["стабильность", "границы", "забота"], [1,0.2,-0.9,0.6,-0.2,0.3,-0.2,0.8,-0.8,0.2]),
    ch("jjk_geto", "Сугуру Гето", "GE", null, "Красивый slow burn с опасной глубиной.", "Спокойный, харизматичный, идейный и сложный в мягком AU.", ["глубина", "эстетика", "тайна"], [0.2,0.4,0.1,1,-0.3,0.9,0.3,0.2,0.7,0.5]),
    ch("jjk_toji", "Тодзи Фушигуро", "TO", null, "Опасный вайб и никаких лишних слов.", "Резкий, независимый, саркастичный и надёжный в опасности.", ["опасность", "свобода", "сарказм"], [-0.3,-0.2,0.8,0.1,0.2,0.2,1,-0.1,0.5,-0.8]),
    ch("jjk_choso", "Чосо", "CH", null, "Тихая привязанность и честная нежность.", "Верный, эмоционально глубокий, странный и искренний.", ["верность", "нежность", "семья"], [0.7,0.4,-0.1,0.8,0.1,0.1,-0.1,0.9,0.4,-0.1]),
    ch("jjk_higuruma", "Хироми Хигурума", "HI", null, "Ум, усталость от мира и честность.", "Интеллектуальный, морально сложный и мягкий в доверии.", ["ум", "честность", "глубина"], [0.5,0.1,-0.6,0.9,-0.4,0.4,-0.1,0.4,0.1,1]),
  ]),
  mha: fandom("mha", "Моя геройская академия", "Только взрослые герои и AU без школьной романтики.", "город героев, агентства, ночные патрули и редкие спокойные выходные", [
    ch("mha_aizawa", "Шота Айзава", "AI", null, "Сонный кот, который на деле опора.", "Сдержанный, прямой, заботливый без показухи.", ["стабильность", "ирония", "границы"], [0.9,-0.1,-0.7,0.6,0.1,0.2,0.1,0.7,-0.6,0.2]),
    ch("mha_hawks", "Хоукс", "HK", null, "Флирт, скорость и улыбка с секретами.", "Лёгкий на словах, умный, свободолюбивый, с глубиной под шутками.", ["харизма", "свобода", "флирт"], [0.1,0.5,0.6,0.5,0.8,0.7,1,0.4,0.3,0.3]),
    ch("mha_best_jeanist", "Бест Джинист", "BJ", null, "Элегантность, контроль и детали.", "Собранный, стильный, дисциплинированный и внимательный.", ["стиль", "контроль", "уважение"], [0.8,0.4,-0.8,0.3,-0.1,0.7,-0.3,0.5,-0.4,0.4]),
    ch("mha_present_mic", "Презент Майк", "PM", null, "Громкий смех, музыка и человек-праздник.", "Шумный, смешной, эмоциональный и тёплый.", ["юмор", "музыка", "энергия"], [0.2,0.4,0.7,0.1,1,0.4,0.6,0.5,-0.2,0.1]),
    ch("mha_fatgum", "Фэт Гам", "FG", null, "Большое сердце, еда и безопасное тепло.", "Открытый, добрый, заботливый, домашний и сильный.", ["забота", "еда", "тепло"], [0.8,0.5,-0.2,0.2,0.6,0.3,0,1,-0.5,-0.2]),
    ch("mha_nighteye", "Сэр Нighteye", "SN", null, "Строгость, интеллект и сухой юмор.", "Точный, требовательный, умный и глубоко преданный.", ["ум", "строгость", "планы"], [0.8,0,-0.8,0.6,0.2,0.8,-0.5,0.3,-0.2,1]),
  ]),
  naruto: fandom("naruto", "Наруто", "Взрослые версии персонажей и спокойный романтический AU-тон.", "Коноха, крыши после миссий, чайные, дороги между деревнями и вечерние огни шиноби", [
    ch("naruto_kakashi", "Какаши Хатаке", "KA", null, "Маска, книжка и человек, который всё замечает.", "Спокойный, умный, травмированный, но тёплый в доверии.", ["тайна", "ум", "верность"], [0.6,0.1,-0.3,0.9,0.3,0.3,0.4,0.5,0.2,0.7]),
    ch("naruto_iruka", "Ирука Умино", "IR", null, "Тёплый дом, честность и возможность выдохнуть.", "Добрый, зрелый, заботливый и эмоционально безопасный.", ["дом", "забота", "безопасность"], [0.9,0.5,-0.8,0.4,0.2,0.1,-0.1,1,-0.7,0.1]),
    ch("naruto_shikamaru", "Шикамару Нара", "SH", null, "Лень, гениальность и отношения без суеты.", "Умный, саркастичный, надёжный и ценящий спокойствие.", ["ум", "спокойствие", "сарказм"], [0.8,0,-0.9,0.5,0.4,-0.1,0.1,0.4,-0.8,1]),
    ch("naruto_gaara", "Гаара", "GA", null, "Тихая нежность и доверие заново.", "Сдержанный, глубокий, ответственный и очень бережный.", ["нежность", "ответственность", "доверие"], [0.9,0.2,-0.7,0.9,-0.4,0.8,-0.2,0.7,0.1,0.2]),
    ch("naruto_yamato", "Ямато", "YA", null, "Стабильность, сухой юмор и деревянный дом мечты.", "Практичный, спокойный, сдержанно смешной и надёжный.", ["стабильность", "дом", "практичность"], [1,0.1,-0.9,0.3,0.3,0.3,-0.2,0.6,-0.7,0.4]),
    ch("naruto_itachi", "Итачи Учиха", "IT", null, "Печальная красота, глубина и тихий выбор.", "Сложный, нежный, трагичный, умный в безопасном взрослом AU.", ["глубина", "тайна", "драма"], [0.3,0.3,-0.3,1,-0.6,0.5,-0.2,0.7,0.9,0.7]),
  ]),
  persona5: fandom("persona5", "Persona 5", "Романтический AU с взрослыми версиями персонажей, без школьной романтики.", "ночной Токио, джаз-бар, метро, дождливые улицы и кафе Leblanc", [
    ch("p5_ren", "Рэн Амамия", "RA", null, "Стильный молчун и центр истории.", "Взрослая AU-версия: спокойный, загадочный, смелый и внимательный.", ["стиль", "тайна", "смелость"], [0.4,0.5,0.4,0.7,0.2,0.7,0.7,0.5,0.2,0.6]),
    ch("p5_ryuji", "Рюдзи Сакамото", "RY", null, "Громкий, честный и живой солнечный хаос.", "Взрослая AU-версия: прямой, смешной, импульсивный и верный.", ["честность", "хаос", "смех"], [0.1,0.3,0.9,0.2,0.9,0.4,0.8,0.6,0.1,-0.5]),
    ch("p5_yusuke", "Юске Китагава", "YU", null, "Искусство, странные фразы и непрактичность.", "Взрослая AU-версия: эстетичный, глубокий, странноватый и искренний.", ["искусство", "странность", "глубина"], [-0.1,0.5,0.3,0.8,0.4,0.5,0.6,0.3,0.2,0.7]),
    ch("p5_akechi", "Горо Акечи", "AK", null, "Идеальная улыбка, шахматы и опасный интеллект.", "Взрослая AU-версия: умный, напряжённый, сложный, slow burn.", ["интеллект", "драма", "контроль"], [-0.2,0.2,0.4,0.9,0.1,1,0.2,0,1,1]),
    ch("p5_iwai", "Мунэхиса Ивай", "IW", null, "Суровый вид, тёплое сердце и никакой ерунды.", "Взрослый, прямой, надёжный, с грубоватой заботой.", ["защита", "ответственность", "тепло"], [0.8,0.1,-0.2,0.5,-0.1,0.2,0.2,0.8,0.2,-0.4]),
    ch("p5_maruki", "Такуто Маруки", "MA", null, "Мягкость, разговоры и желание всё исправить.", "Взрослый, внимательный, заботливый, интеллектуальный и немного драматичный.", ["эмпатия", "разговоры", "ум"], [0.4,0.4,-0.4,0.8,0,0.6,-0.4,1,0.5,0.9]),
  ]),
  bg3: fandom("bg3", "Baldur's Gate 3", "Фэнтези, костёр, опасные дороги и романтический вайб.", "Фаэрун, лагерь у костра, таверны, руины, магия и ночи под звёздами", [
    ch("bg3_astarion", "Астарион", "AS", null, "Флирт, сарказм и нежность, которой страшно доверять.", "Острый, театральный, свободолюбивый, драматичный и ранимый.", ["флирт", "сарказм", "свобода"], [-0.4,0.7,0.5,0.8,0.7,0.4,1,0.2,1,0.2]),
    ch("bg3_gale", "Гейл", "GA", null, "Магия, умные разговоры и переусложнённый ужин.", "Тёплый, книжный, романтичный, немного драматичный и разговорчивый.", ["магия", "романтика", "книги"], [0.3,0.8,0.1,0.8,0.4,0.8,0.1,0.7,0.5,1]),
    ch("bg3_wyll", "Уилл", "WY", null, "Рыцарство, честь и танец у костра.", "Благородный, добрый, романтичный, ответственный и чуть сказочный.", ["честь", "романтика", "доброта"], [0.7,0.9,-0.1,0.4,0.2,0.7,0.2,0.8,0.2,0.1]),
    ch("bg3_halsin", "Хальсин", "HA", null, "Лес, спокойствие и объятия размером с медведя.", "Спокойный, природный, свободный, зрелый и бережный.", ["природа", "зрелость", "забота"], [0.7,0.5,-0.3,0.5,0.1,0.1,1,0.9,-0.4,0.2]),
    ch("bg3_rolan", "Ролан", "RO", null, "Сарказм, амбиции и маг, который растёт рядом.", "Колкий, гордый, умный, амбициозный, но способный на преданность.", ["сарказм", "амбиции", "магия"], [0.2,0.2,0.1,0.5,0.4,1,0.2,0.4,0.4,0.9]),
    ch("bg3_dammon", "Даммон", "DA", null, "Кузница, доброе сердце и любовь через заботливые руки.", "Тёплый, практичный, честный, спокойный и поддерживающий.", ["тепло", "ремесло", "дом"], [0.9,0.5,-0.6,0.3,0.1,0.3,0.1,1,-0.5,0.3]),
  ]),
};
