...
function buildAnswerProfile(answers) {
  const categoryGuides = {
    ...
    boundaries: {
      high: "ценит зрелые границы, честные разговоры и способность чинить конфликт без драматичного давления",
      mid: "хочет мягкого баланса между прямотой, паузами и взаимным уважением",
      low: "раскрывается лучше, когда рядом не форсируют сложные разговоры и дают больше пространства",
    },
    adventure: {
      high: "оживает от дороги, спонтанности, маленького риска и ощущения общей миссии",
      mid: "любит приключения, если рядом остаётся чувство безопасности и опоры",
      low: "скорее выбирает спокойный маршрут, знакомые места и предсказуемую нежность",
    },
    comfort: {
      high: "сильно откликается на бытовую заботу, общие ритуалы и ощущение дома рядом с человеком",
      mid: "ценит уют, но не хочет, чтобы отношения теряли воздух и движение",
      low: "меньше держится за быт и сильнее откликается на события, рост и перемены",
    },
    values: {
      high: "влюбляется через уважение к принципам, честности, стойкости и внутреннему выбору человека",
      mid: "ищет живой баланс между чувствами, личными целями и моральной ясностью",
      low: "скорее выбирает лёгкость момента, чем постоянные разговоры о смысле и принципах",
    },
    attention: {
      high: "любит заметное внимание, флирт, конкретные комплименты и маленькие жесты выбранности",
      mid: "ценит романтическую искру, если она не давит и не превращается в спектакль",
      low: "лучше реагирует на тихую заботу и поступки, чем на активный флирт и демонстративную романтику",
    },
  };
